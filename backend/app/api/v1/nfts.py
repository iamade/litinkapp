...
async def create_nft(
    ...
    result = await blockchain_service.create_nft(
        ...
        creator_mnemonic=current_user.wallet_mnemonic # Assuming user has mnemonic
    )
    ...
    if response.error:
        # If blockchain part succeeded but DB fails, we have an issue.
        # A more robust system would handle this with retries or a cleanup job.
