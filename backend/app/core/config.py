...
class Settings(BaseSettings):
    ...
    JWT_ACCESS_TOKEN_EXPIRATION_MINUTES: int = 30 if ENVIRONMENT == "development" else 15
    ...
    COOKIE_PATH: str = "/"
    SIGNING_KEY: str = ""
    PASSWORD_RESET_TOKEN_EXPIRATION_MINUTES: int = 3 if ENVIRONMENT == "development" else 5
