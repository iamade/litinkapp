...
def upgrade() -> None:
    ...
    sa.Column('traits', postgresql.JSONB(astext_type=sa.Text()), server_default=sa.text("'{}'::jsonb"), nullable=True),
    sa.Column('typical_roles', postgresql.JSONB(astext_type=sa.Text()), server_default=sa.text("'{}'::jsonb"), nullable=True),
    sa.Column('example_characters', sqlmodel.sql.sqltypes.AutoString(), nullable=True),
    ...
    op.create_index(op.f('ix_image_records_chapter_id'), 'image_records', ['chapter_id'], unique=False)
    op.create_index(op.f('ix_image_records_script_id'), 'image_records', ['script_id'], unique=False)
    op.create_index(op.f('ix_image_records_user_id'), 'image_records', ['user_id'], unique=False)
    op.create_table('plot_overviews',
    sa.Column('id', sa.UUID(), server_default=sa.text('gen_random_uuid()'), nullable=False),
    sa.Column('book_id', sa.UUID(), nullable=False),
    sa.Column('user_id', sa.UUID(), nullable=False),
    sa.Column('logline', sqlmodel.sql.sqltypes.AutoString(), nullable=True),
    sa.Column('themes', postgresql.JSONB(astext_type=sa.Text()), server_default=sa.text("'[]'::jsonb"), nullable=True),
    sa.Column('story_type', sqlmodel.sql.sqltypes.AutoString(), nullable=True),
    sa.Column('script_story_type', sqlmodel.sql.sqltypes.AutoString(), nullable=True),
    ...
    sa.Column('generation_method', sqlmodel.sql.sqltypes.AutoString(), nullable=True),
    ...
    op.create_index(op.f('ix_plot_overviews_book_id'), 'plot_overviews', ['book_id'], unique=False)
    op.create_index(op.f('ix_plot_overviews_user_id'), 'plot_overviews', ['user_id'], unique=False)
    ...
    op.create_index(op.f('ix_usage_logs_subscription_id'), 'usage_logs', ['subscription_id'], unique=False)
    op.create_index(op.f('ix_usage_logs_user_id'), 'usage_logs', ['user_id'], unique=False)
    op.create_table('user_subscriptions',
    sa.Column('id', sa.UUID(), server_default=sa.text('gen_random_uuid()'), nullable=False),
    sa.Column('user_id', sa.UUID(), nullable=False),
    sa.Column('tier', postgresql.ENUM('FREE', 'BASIC', 'PRO', name='subscription_tier'), nullable=False),
    sa.Column('status', postgresql.ENUM('ACTIVE', 'CANCELLED', 'EXPIRED', 'PAST_DUE', 'TRIALING', name='subscription_status'), nullable=False),
    ...
    sa.Column('user_id', sa.UUID(), nullable=False),
    sa.Column('script_id', sa.UUID(), nullable=True),
    sa.Column('generation_status', postgresql.ENUM('PENDING', 'GENERATING_AUDIO', 'AUDIO_COMPLETED', 'GENERATING_IMAGES', 'IMAGES_COMPLETED', 'GENERATING_VIDEO', 'VIDEO_COMPLETED', 'MERGING_AUDIO', 'APPLYING_LIPSYNC', 'COMBINING', 'COMPLETED', 'FAILED', 'RETRYING', name='video_generation_status'), nullable=False),
    sa.Column('quality_tier', postgresql.ENUM('FREE', 'BASIC', 'STANDARD', 'STANDARD_2', 'PRO', 'MASTER', name='video_quality_tier'), nullable=False),
    ...
    sa.Column('task_meta', postgresql.JSONB(astext_type=sa.Text()), server_default=sa.text("'{}'::jsonb"), nullable=True),
    sa.Column('script_data', postgresql.JSONB(astext_type=sa.Text()), server_default=sa.text("'{}'::jsonb"), nullable=True),
    sa.Column('audio_files', postgresql.JSONB(astext_type=sa.Text()), server_default=sa.text("'{}'::jsonb"), nullable=True),
    sa.Column('image_data', postgresql.JSONB(astext_type=sa.Text()), server_default=sa.text("'{}'::jsonb"), nullable=True),
    sa.Column('video_data', postgresql.JSONB(astext_type=sa.Text()), server_default=sa.text("'{}'::jsonb"), nullable=True),
    sa.Column('merge_data', postgresql.JSONB(astext_type=sa.Text()), server_default=sa.text("'{}'::jsonb"), nullable=True),
    sa.Column('lipsync_data', postgresql.JSONB(astext_type=sa.Text()), server_default=sa.text("'{}'::jsonb"), nullable=True),
    sa.Column('created_at', postgresql.TIMESTAMP(timezone=True), server_default=sa.text('CURRENT_TIMESTAMP'), nullable=False),
    sa.Column('updated_at', postgresql.TIMESTAMP(timezone=True), server_default=sa.text('CURRENT_TIMESTAMP'), nullable=False),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_video_generations_chapter_id'), 'video_generations', ['chapter_id'], unique=False)
    op.create_index(op.f('ix_video_generations_script_id'), 'video_generations', ['script_id'], unique=False)
    ...
    sa.Column('audio_type', postgresql.ENUM('NARRATOR', 'CHARACTER', 'SOUND_EFFECTS', 'BACKGROUND_MUSIC', name='audio_type'), nullable=False),
    ...
    op.create_index(op.f('ix_audio_generations_video_generation_id'), 'audio_generations', ['video_generation_id'], unique=False)
    op.create_table('chapter_scripts',
    sa.Column('id', sa.UUID(), server_default=sa.text('gen_random_uuid()'), nullable=False),
    sa.Column('chapter_id', sa.UUID(), nullable=False),
    ...
    sa.Column('scenes', postgresql.JSONB(astext_type=sa.Text()), server_default=sa.text("'{}'::jsonb"), nullable=True),
    sa.Column('acts', postgresql.JSONB(astext_type=sa.Text()), server_default=sa.text("'{}'::jsonb"), nullable=True),
    sa.Column('beats', postgresql.JSONB(astext_type=sa.Text()), server_default=sa.text("'{}'::jsonb"), nullable=True),
    sa.Column('character_details', postgresql.JSONB(astext_type=sa.Text()), server_default=sa.text("'{}'::jsonb"), nullable=True),
    sa.Column('character_arcs', postgresql.JSONB(astext_type=sa.Text()), server_default=sa.text("'{}'::jsonb"), nullable=True),
    sa.Column('generation_metadata', postgresql.JSONB(astext_type=sa.Text()), server_default=sa.text("'{}'::jsonb"), nullable=True),
    sa.Column('status', sqlmodel.sql.sqltypes.AutoString(), nullable=False),
    sa.Column('version', sa.Integer(), nullable=False),
    sa.Column('created_at', postgresql.TIMESTAMP(timezone=True), server_default=sa.text('CURRENT_TIMESTAMP'), nullable=False),
    sa.Column('updated_at', postgresql.TIMESTAMP(timezone=True), server_default=sa.text('CURRENT_TIMESTAMP'), nullable=False),
    sa.ForeignKeyConstraint(['plot_overview_id'], ['plot_overviews.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_chapter_scripts_chapter_id'), 'chapter_scripts', ['chapter_id'], unique=False)
    op.create_index(op.f('ix_chapter_scripts_plot_overview_id'), 'chapter_scripts', ['plot_overview_id'], unique=False)
    op.create_index(op.f('ix_chapter_scripts_user_id'), 'chapter_scripts', ['user_id'], unique=False)
    ...
    sa.Column('archetypes', postgresql.JSONB(astext_type=sa.Text()), server_default=sa.text("'[]'::jsonb"), nullable=True),
    ...
    sa.Column('image_url', sqlmodel.sql.sqltypes.AutoString(), nullable=True),
    sa.Column('image_generation_prompt', sqlmodel.sql.sqltypes.AutoString(), nullable=True),
    sa.Column('image_metadata', postgresql.JSONB(astext_type=sa.Text()), server_default=sa.text("'{}'::jsonb"), nullable=True),
    sa.Column('created_at', postgresql.TIMESTAMP(timezone=True), server_default=sa.text('CURRENT_TIMESTAMP'), nullable=False),
    sa.Column('updated_at', postgresql.TIMESTAMP(timezone=True), server_default=sa.text('CURRENT_TIMESTAMP'), nullable=False),
    sa.ForeignKeyConstraint(['plot_overview_id'], ['plot_overviews.id'], ),
    sa.PrimaryKeyConstraint('id')
    ...
    op.create_index(op.f('ix_characters_plot_overview_id'), 'characters', ['plot_overview_id'], unique=False)
    ...
    op.create_index(op.f('ix_image_generations_video_generation_id'), 'image_generations', ['video_generation_id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_image_generations_video_generation_id'), table_name='image_generations')
    ...
    op.drop_index(op.f('ix_chapter_scripts_plot_overview_id'), table_name='chapter_scripts')
    op.drop_index(op.f('ix_chapter_scripts_chapter_id'), table_name='chapter_scripts')
    op.drop_table('chapter_scripts')
    op.drop_index(op.f('ix_audio_generations_video_generation_id'), table_name='audio_generations')
    op.drop_table('audio_generations')
    op.drop_index(op.f('ix_video_generations_user_id'), table_name='video_generations')
    op.drop_index(op.f('ix_video_generations_script_id'), table_name='video_generations')
    op.drop_index(op.f('ix_video_generations_chapter_id'), table_name='video_generations')
